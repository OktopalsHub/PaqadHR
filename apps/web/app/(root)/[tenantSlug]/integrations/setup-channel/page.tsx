      ...
      <AppPage>
        <ContentCard title="Slack channel setup" description="Missing integration ID">
          <p className="text-sm text-muted-foreground">
            Start by connecting Slack from Settings, then return here to pick a channel.
          </p>
          <Button className="mt-4" variant="outline" onClick={() => router.push(tenantHref('settings'))}>
            Back to Settings
          </Button>
        </ContentCard>
      </AppPage>
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="outline" onClick={() => router.push(tenantHref('settings'))}>
                Cancel
              </Button>
            </div>
          </div>
