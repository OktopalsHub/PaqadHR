...
export default function OnboardingLayout({ children }: { children: ReactNode }) {
  return (
    <ForceLightTheme>
      <div className="relative h-svh overflow-hidden bg-[linear-gradient(135deg,#edf8f3_0%,#f8fbfa_46%,#ebf7f1_100%)]">
        <div
          aria-hidden="true"
        ...
        <div className="relative z-10 flex h-full flex-col px-3 pb-4 pt-3 sm:px-4 sm:pb-5 sm:pt-4 lg:px-6 lg:pb-7 lg:pt-5">
