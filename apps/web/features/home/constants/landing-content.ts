...
export const services = [
  {
    ...
    description:
      "Org charts, profiles, and employment records kept current in one place.",
  },
  {
    icon: Briefcase,
    title: "Recruitment",
    description:
      "Publish roles, track candidates, and move hires through your pipeline.",
  },
  {
    icon: Wallet,
    title: "Payroll exports",
    description:
      "Run calculations, export bank files, and mark disbursements offline.",
  },
  {
    icon: Calendar,
    title: "Leave management",
    description:
      "Requests, balances, and team calendars without spreadsheet chaos.",
  },
  {
    icon: Heart,
    title: "Shoutouts",
    description:
      "Peer recognition with points and a feed your team actually uses.",
  },
  {
    icon: LineChart,
    title: "Workforce insights",
    description:
      "Headcount, attendance trends, and lightweight analytics at a glance.",
  },
];
