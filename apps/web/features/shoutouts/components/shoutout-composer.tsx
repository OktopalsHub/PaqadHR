...
export function ShoutoutComposer({
  ...
  const formFields = (
    <div className="space-y-3">
      {points ? (
        <div className="grid grid-cols-2 gap-2 rounded-lg border bg-background/60 p-3 text-center">
          <div>
            <p className="text-lg font-semibold tabular-nums text-primary">
              {points.remainingAllowance}
            </p>
            <p className="text-[11px] text-muted-foreground">{PAQ_POINTS_NAME} to give</p>
          </div>
          <div>
      ...
      <div className="space-y-2">
        <Label htmlFor="shoutout-points">{PAQ_POINTS_NAME}</Label>
        <Input
          id="shoutout-points"
          type="number"
          min={1}
    ...
    >
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0 flex-1">
          <h3 className="text-sm font-semibold">Give a shoutout</h3>
