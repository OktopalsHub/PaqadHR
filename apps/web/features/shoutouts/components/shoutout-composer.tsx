...
function findActiveToken(value: string, caret: number): ActiveToken | null {
  ...
  // Only trigger at the start of a word (avoid emails etc.)
      ...
      <div className="mt-4 space-y-4">
        <div className="relative rounded-xl border border-border/60 bg-muted/20 p-3 transition-all focus-within:border-primary/50 focus-within:ring-1 focus-within:ring-primary/20">
          <textarea
            ...
            onKeyUp={(e) => syncActive(e.currentTarget.value, e.currentTarget.selectionStart ?? 0)}
            onClick={(e) => syncActive(e.currentTarget.value, e.currentTarget.selectionStart ?? 0)}
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <div className="relative">
              ...
              {emojiOpen ? (
                <div className="absolute left-0 top-full z-20 mt-1 grid grid-cols-5 gap-1 rounded-lg border border-border bg-popover p-2 shadow-lg">
                  {EMOJIS.map((emoji) => (
                    <button
                      key={emoji}
                      type="button"
