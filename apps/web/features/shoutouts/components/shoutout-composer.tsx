...
export type ShoutoutComposerHandle = {
...
export const ShoutoutComposer = forwardRef<ShoutoutComposerHandle, ShoutoutComposerProps>(
  function ShoutoutComposer(
    ...
    const remainingAllowance = points?.remainingAllowance;
    ...
    const projectedRemaining =
      remainingAllowance != null ? Math.max(0, remainingAllowance - parsed.totalPoints) : null;
