...
function createEventCalendarStore<TData>(
  ...
  const setField = <K extends ControlledKey>(
    ...
    if (!controlled) {
      // biome-ignore lint/suspicious/noExplicitAny: dynamic keyed write into internal state
...
const EventCalendarContext =
  // biome-ignore lint/suspicious/noExplicitAny: generic context needs a single erased type
