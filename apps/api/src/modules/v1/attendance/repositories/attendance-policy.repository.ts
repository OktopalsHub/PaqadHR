...
export class AttendancePolicyRepository extends Repository<AttendancePolicy> {
  constructor(
    ...
    readonly attendancePolicyRepository: Repository<AttendancePolicy>,
  ) {
    super(
      attendancePolicyRepository.target,
      attendancePolicyRepository.manager,
      attendancePolicyRepository.queryRunner,
    );
  }
}
