...
export class AttendanceExceptionRepository extends Repository<AttendanceException> {
  constructor(
    ...
    readonly attendanceExceptionRepository: Repository<AttendanceException>,
  ) {
    super(
      attendanceExceptionRepository.target,
      attendanceExceptionRepository.manager,
      attendanceExceptionRepository.queryRunner,
    );
  }
}
