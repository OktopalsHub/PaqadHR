...
export class PaymentSecurityRepository extends Repository<PaymentSecurity> {
  constructor(
    ...
    readonly paymentSecurityRepository: Repository<PaymentSecurity>,
  ) {
    super(
      paymentSecurityRepository.target,
      paymentSecurityRepository.manager,
      paymentSecurityRepository.queryRunner,
    );
  }
}
