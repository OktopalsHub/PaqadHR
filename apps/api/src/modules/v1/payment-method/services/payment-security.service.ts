...
export class PaymentSecurityService {
  constructor(
    private readonly paymentSecurityRepo: PaymentSecurityRepository,
  ) {}
  async setPasscode(
    memberId: string,
