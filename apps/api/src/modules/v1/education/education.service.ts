...
export class EducationService {
  ...
  async createEducation(
    ...
    return this.educationRepository.createEducation(createEducationDto, tenantId, memberId);
  }
  ...
  async updateEducation(
    ...
    return this.educationRepository.updateEducation(id, updateEducationDto, tenantId);
  }
