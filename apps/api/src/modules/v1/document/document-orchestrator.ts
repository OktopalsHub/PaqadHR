...
export class DocumentService {
  ...
  constructor(
    ...
    this.getEmployeeDocumentsByType =
      this.upload.getEmployeeDocumentsByType.bind(this.upload);
    ...
    this.getDocumentsByAccessLevel =
      this.upload.getDocumentsByAccessLevel.bind(this.upload);
    this.filterDocumentsForMember =
      this.upload.filterDocumentsForMember.bind(this.upload);
    ...
    this.getDocumentsByVerificationStatus =
      this.verification.getDocumentsByVerificationStatus.bind(this.verification);
    this.getExpiringDocuments =
      this.verification.getExpiringDocuments.bind(this.verification);
    this.bulkVerifyDocuments =
      this.verification.bulkVerifyDocuments.bind(this.verification);
    this.bulkDeleteDocuments =
      this.verification.bulkDeleteDocuments.bind(this.verification);
    this.getDocumentAccessLogs =
      this.verification.getDocumentAccessLogs.bind(this.verification);
    this.logDocumentAccess = this.verification.logDocumentAccess.bind(this.verification);
    this.getDocumentTemplates =
      this.verification.getDocumentTemplates.bind(this.verification);
    this.initiateDigitalSignature =
      this.verification.initiateDigitalSignature.bind(this.verification);
    this.getDocumentStatistics =
      this.verification.getDocumentStatistics.bind(this.verification);
  }
}
