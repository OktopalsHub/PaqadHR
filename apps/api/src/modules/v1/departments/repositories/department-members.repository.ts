...
export class DepartmentMembersRepository extends Repository<DepartmentMember> {
  constructor(
    ...
    readonly departmentMemberRepository: Repository<DepartmentMember>,
  ) {
    super(
      departmentMemberRepository.target,
      departmentMemberRepository.manager,
      departmentMemberRepository.queryRunner,
    );
  }
}
