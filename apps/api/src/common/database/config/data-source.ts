...
const AppDataSource = {
  ...
  migrations: [
    ...
    Migrations.ApiKeys1787950600190,
    Migrations.PendingAgentActions1787950604839,
    Migrations.AgentActionIdempotency1787950608947,
    Migrations.TenantActivityActorColumns1787950615610,
    Migrations.AddPositionDeletedAt1788205216357,
    Migrations.AddLeaveBalanceDeletedAt1788205216358,
    Migrations.PayrollRunUniquePerCurrency1788305216359,
  ],
