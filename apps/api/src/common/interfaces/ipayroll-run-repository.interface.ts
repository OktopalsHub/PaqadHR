...
import { PayrollRun } from "../../modules/v1/payroll/entities/payroll-run.entity";
...
export interface IPayrollRunRepository {
    ...
    findByTenantAndPeriod(tenantId: string, periodStart: Date, periodEnd: Date): Promise<PayrollRun | null>;
    ...
    findAll(includeDeleted?: boolean, where?: FindManyOptions<PayrollRun>['where'], relations?: string[]): Promise<PayrollRun[]>;
    findById(id: string, includeDeleted?: boolean, additionalWhere?: FindOneOptions<PayrollRun>['where'], relations?: string[]): Promise<PayrollRun | null>;
    ...
    findAllPaginated(page: number, limit: number, includeDeleted?: boolean, where?: FindManyOptions<PayrollRun>['where'], relations?: string[], name?: string): Promise<IPaginatedData<PayrollRun>>;
