import { Document } from "../../modules/v1/document/entities/document.entity";
import { DocumentType } from "../enums/document-type.enum";

export interface IDocumentRepository {
    createDocument(createDocumentDto: Partial<Document>, tenantId: string, tenantMemberId: string): Promise<Document>;
    ...
    updateDocument(id: string, updateDocumentDto: Partial<Document>, tenantId: string): Promise<Document>;
