import { Position } from "../../modules/v1/position/entities/position.entity";
...
export interface IPositionRepository {
    ...
    updatePosition(id: string, updatePositionDto: Partial<Position>, tenantId: string): Promise<Position>;
